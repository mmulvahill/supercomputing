---
title: "Supercomputing Resources README"
author: 
  - Matt Mulvahill
...
- High-performance computing (HPC)
    - Individual programs that take advantage of multiple cores and multiple nodes
      typicaly via MPI.
...
- [Overview of cluster computing options](https://cloud.google.com/solutions/using-clusters-for-large-scale-technical-computing)
    - Slurm, Univa Grid Engine, and LSF Symphony are all also possible
      solutions.  Especially if HPC clustering is required.
